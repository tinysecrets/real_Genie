...
// Craco sets NODE_ENV=development for `start` and NODE_ENV=production for `build`.
...
// Wrap with visual edits (adds babel plugin, dev server, and overlay in dev mode).
if (isDevServer) {
  try {
